...
const Footer = () => {
  return (
    <div id='Contact' className='sm:flex-row sm:justify-around flex flex-col bg-[#465697] text-white p-10 md:p-6 sm:items-center '>
      <div className="">
        ...
        <ul className='text-sm  md:text-xl '>
            <li className='flex gap-4 py-1 px-4 items-center'><FaEnvelope />guptabhanu782@gmail.com</li>
